...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#fafafa] font-sans text-zinc-950">
      {/* Announcement */}
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-16 md:py-20 lg:min-h-[620px] lg:grid-cols-[1.05fr_.95fr] lg:px-8">
          <div>
            ...
            <h1 className="max-w-3xl text-4xl font-black leading-[1.02] tracking-[-0.04em] sm:text-6xl lg:text-7xl">
              Handy, Internet
              <br />
              <span className="text-fuchsia-600">& persönliche Beratung.</span>
            </h1>

            <p className="mt-7 max-w-xl text-lg leading-8 text-zinc-600">
              Mobilfunk, Smartphones, Internet und Service – einfach vergleichen
              und persönlich beraten lassen.
            </p>
            ...
            {branches.map((branch) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-2 text-2xl font-black">{branch.city}</div>
          ...
          <div className="grid gap-10 lg:grid-cols-[.7fr_1.3fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-md leading-7 text-zinc-600">
                Beratung und Service sollen genauso einfach sein wie die Website
                selbst.
              </p>
            </div>
